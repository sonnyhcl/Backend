...
public class GlobalVariables {
    ...
    public GlobalVariables() {
        ...
        this.portsInfo.put("武穴", new VPort("武穴", "AfterAD", 3.8, 2.1, "115.5674", "29.83692", true, 1));
        this.portsInfo.put("九江", new VPort("九江", "AfterAD", 5.6, 2.1, "115.95308", "29.72574", true, 2));
        ...
        this.portsInfo.put("铜陵", new VPort("铜陵", "AfterAD", 4.3, 2.1, "117.7291", "30.95259", true, 5));
        ...
        this.portsInfo.put("南京", new VPort("南京", "AfterAD", 5.6, 2.1, "118.800095", "32.146214", true, 8));
